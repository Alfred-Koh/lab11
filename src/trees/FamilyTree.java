...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		// Extract parent and array of children.
		 int colonIndex = line.indexOf(":");
	        if (colonIndex < 0) {
	            throw new TreeException("Illegal format: No colon on line \"" + line + "\"");
	        }
	        ...
	        if (root == null) {
	            ...
	            if (parentNode == null) {
	                throw new TreeException("Illegal format: Can't find parent \"" + parent + "\"");
	            }
	        }
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null) {
			throw new TreeException("Node " + name1 + " not found in the tree.");
		}
		TreeNode node2 = root.getNodeWithName(name2); // node whose name is name2
		if (node2 == null) {
			throw new TreeException("Node " + name2 + " not found in the tree.");
		}
